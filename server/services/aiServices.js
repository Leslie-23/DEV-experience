const checkAnswer = async (question, userAnswer) => {
  const correctAnswer = question.correctAnswer; // Ensure your Question model has this field

  const isCorrect = correctAnswer === userAnswer;
  return {
    feedback: isCorrect ? "Correct answer!" : "Incorrect, try again.",
    rating: isCorrect ? 5 : 2, // Adjust rating logic as needed
  };
};

module.exports = { checkAnswer };

// will come to AI for now MVP is  needed
